...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'h-[56px] rounded-2xl px-2 font-semibold transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center'
